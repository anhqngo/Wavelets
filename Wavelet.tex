...
To illustrate this convergence better, see Figure \ref{fig:converge} for the sequence $ \{P_nf\} $ approaching $ f(x) = x^2 $ on the unit interval.
	...
	\begin{subfigure}[b]{0.475\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/approximate0}
		\caption[Network2]%
		{{\small $ n = 0 $}}    
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.475\textwidth}  
		\centering 
		\includegraphics[width=\textwidth]{img/approximate1}
		\caption[]%
		{{\small $ n = 1 $}}
	\end{subfigure}
	\vskip\baselineskip
	\begin{subfigure}[b]{0.475\textwidth}   
		\centering 
		\includegraphics[width=\textwidth]{img/approximate2}
		\caption[]%
		{{\small $ n = 2 $}}    
	\end{subfigure}
	\quad
	\begin{subfigure}[b]{0.475\textwidth}   
		\centering 
		\includegraphics[width=\textwidth]{img/approximate5}
		\caption[]%
		{{\small $ n = 5 $}}    
	\end{subfigure}
	\caption[]
	{Approximation of $ f(x) = x^2 $ by $ P_nf(x) $ as $ n $ increases}
	\label{fig:converge}
\end{figure}\change{Fix the graph if there's time}
